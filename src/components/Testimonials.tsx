...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    { name: "Zuzanna W.", business: "Salon fryzjerski - Wołomin", text: "Bardzo polecam Agencję Aurine, a zwłaszcza specjalistę Pana Przemka. Świetne podejście i wiedza dają szybkie efekty. Od początku współpracy czuję się zaopiekowana - wszystko jest jasne, przejrzyste i bez zbędnego stresu. Widzę realną różnicę w liczbie nowych klientek 😊", rating: 5 },
    { name: "Magdalena W.", business: "Gabinet kosmetyczny - Marki", text: "Serdecznie polecam. Pan Przemek ma super podejście, nawet trudne rzeczy wyjaśniał w prosty sposób. Zawsze mogę liczyć na szybką odpowiedź i konkretne porady. Współpraca przebiega bardzo płynnie, a efekty są lepsze niż się spodziewałam!", rating: 5 },
    { name: "Aleksandra S.", business: "Studio urody - Ząbki", text: "Profesjonalna obsługa i widoczne rezultaty. Polecam współpracę z Aurine każdej właścicielce salonu, która chce rozwijać swój biznes. Zespół naprawdę rozumie branżę beauty i wie, jak dotrzeć do odpowiednich klientek.", rating: 5 },
    { name: "Karolina M.", business: "Salon kosmetyczny - Sulejówek", text: "Współpraca z Aurine to strzał w dziesiątkę! Liczba klientek w moim salonie wzrosła znacząco w ciągu pierwszych dwóch miesięcy. Pełen profesjonalizm i zaangażowanie.", rating: 5 },
    { name: "Natalia K.", business: "Gabinet beauty - Piastów", text: "Współpraca z Aurine to czysta przyjemność. Kontakt jest świetny, zawsze mogę napisać z pytaniem i dostaję szybką, jasną odpowiedź. Wszystko tłumaczą normalnie, po ludzku. Jestem bardzo zadowolona i polecam każdemu salonowi beauty! 😌", rating: 5 },
    { name: "Joanna B.", business: "Studio stylizacji - Kobyłka", text: "Współpracuję z Aurine już od kilku miesięcy i z pełnym przekonaniem mogę polecić Przemka i cały zespół. Naprawdę wiedzą, jak robić marketing lokalny i przyciągać klientów. Dzięki nim zauważyłam realny wzrost zainteresowania moimi usługami.", rating: 5 },
  ];
