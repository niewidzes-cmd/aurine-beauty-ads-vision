  ...
  return (
    <section ref={ref} id="contact" className={`section-padding bg-[#050505] relative overflow-hidden transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-white/[0.05] border border-white/[0.1] rounded-xl p-5 sm:p-8 animate-scale-in">
          <div className="grid sm:grid-cols-3 gap-5 sm:gap-6 mb-6 sm:mb-8">
            {[
              ...
              <a key={index} href={contact.href} className="group text-center hover:scale-105 transition-transform">
                <div className="inline-flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 bg-primary/10 rounded-full mb-2 group-hover:bg-primary/20 transition-colors">
                  <contact.icon className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                </div>
                <div className="text-[10px] sm:text-xs text-white/50 mb-0.5">{contact.title}</div>
